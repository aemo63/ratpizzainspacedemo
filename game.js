...
const scoreText = document.getElementById("finalScore"); // Changed to scoreText
...
function gameOver() {
    ...
    scoreText.textContent = `Your final score is: ${score}`; // Changed to scoreText
    resetGame();
}
